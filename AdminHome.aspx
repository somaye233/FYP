...
<asp:Content ID="Content1" ContentPlaceHolderID="MainContent" Runat="Server">
     <div style="width:100%; height:500px; text-align: left;">
        <div style="margin-left:25%;width:50%;float:left;text-align:center;height:100%">
            ...
            <br />
            <br />
            <asp:Image ID="Image1" runat="server" Height="103px" ImageUrl="~/Images/userManagment.jpg" />
            <br />
            <asp:HyperLink ID="HyperLink1" runat="server" NavigateUrl="~/AccountManagment.aspx">Account Managment</asp:HyperLink>
            <br />
            <br />
            <br />
