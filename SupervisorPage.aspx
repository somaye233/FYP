<%@ Page Title="" Language="C#" MasterPageFile="~/Site.master" AutoEventWireup="true" CodeFile="SupervisorPage.aspx.cs" Inherits="SupervisorPage" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="MainContent" Runat="Server">
    <div style="width:100%; height:800px; text-align: left;">
        <div style="margin-left:15%;width:80%;float:left;text-align:center;height:100%">
            ...
            <asp:Button ID="Button8" runat="server" BackColor="#003366" BorderStyle="None" Font-Bold="True" ForeColor="White" Text="Finalize" Width="186px" OnClick="Button8_Click"  />
            <br />
            </span></span>
